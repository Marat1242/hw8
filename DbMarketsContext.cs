...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=dbMarkets;Integrated Security=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.QuangCaoId).HasName("PK_QuangCaos");
    ...
    //public DbSet<Supermarket.ModelViews.RegisterViewModel> RegisterViewModel { get; set; } = default!;

    //public DbSet<Supermarket.ModelViews.LoginViewModel> LoginViewModel { get; set; } = default!;
}
